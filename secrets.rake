...
namespace :secrets do
  ...
  task :decrypt do
    ...
    env_secret_file = File.open('/app/.env.secret', 'rb')
    ...
    env_iv_file = File.open('/app/.env.iv', 'rb')
    ...
    env_plain_file = File.open('/app/.env', 'wb')
  ...
  task :encrypt do
    ...
    env_plain_file = File.open('/app/.env', 'rb')
